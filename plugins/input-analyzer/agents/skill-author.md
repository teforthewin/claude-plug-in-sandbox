...
**Activation**: Called by `input-analyzer` orchestrator at the end of Phase 1, **after** conflict resolution. Do not invoke directly.
...
> Auto-generated by `input-analyzer/skill-author`. Manual edits in `## Manual Notes` are preserved across re-runs. Do not edit other sections by hand.
